...
// codewars.com/kata/5f7b1a82be51af00105c82bd/train/javascript


function divBy9(ns){

    return (ns.split('').reduce((a, b) => +a + +b)) % 9 === 0
}

console.log(divBy9("777777777777777777777777777777777777777777777"))
